...
import { PageWrapper, Sidebar, SidebarBrand, SidebarNav, NavItem, MainContentWrapper, Content, ContentInner, ProductCard, ProductImage, 
    ProductDetails, ButtonGroup, H1, H2, H3, H4, H5, H6, P, Pprice } from "@/styled/Admin.styles";
                    ...
                    {products.map((p) => (
                        <ProductCard key={p.id} onClick={() => openModal("view", p.id)}>
                            ...
                            <ButtonGroup>
                                ...
                                variant="primary"
                                size="sm"
                                onClick={(e) => {e.stopPropagation(); openModal("edit", p.id);}}
                                >수정</Button>
                                <Button
                                variant="danger"
                                size="sm"
